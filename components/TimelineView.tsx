...
// Optimization: Passing an accumulator array (`entries`) instead of doing `entries.push(...flattenEntries())`
// to avoid O(N²) array allocations during deep tree flattening.
